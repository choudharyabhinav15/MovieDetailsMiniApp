package com.walmartlabs.ern.moviedetailsminiapp;

import com.walmartlabs.ern.container.miniapps.MovieDetailsMiniAppActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = MovieDetailsMiniAppActivity.class;
